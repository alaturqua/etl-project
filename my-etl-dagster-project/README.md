...
You can start writing assets in `my_etl_dagster_project/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `my_etl_dagster_project_tests` directory and you can run tests using `pytest`:

```bash
pytest my_etl_dagster_project_tests
```
